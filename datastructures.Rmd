...
"Linkhand", "Messer", "SchwererDolch"), technik = c("Dolche", 
"Dolche", "Dolche", "Dolche", "Dolche", "Dolche"), leiteigenschaft = c("GE", 
"GE", "GE", "GE", "GE", "GE"), schwelle = c(14L, 14L, 14L, 14L, 
14L, 14L), grundschaden = c("1W6", "1W6", "1W6", "1W6", "1W6", 
"1W6"), bonus = c(2L, 1L, 2L, 1L, 1L, 2L), at = c(0L, 0L, 0L, 
0L, 0L, 0L), pa = c(-1L, 0L, -1L, 0L, -2L, -1L), rw = c("kurz", 
"kurz", "kurz", "kurz", "kurz", "kurz"), gewicht = c("0,5Stn", 
"0,5Stn", "0,75Stn", "0,75Stn", "0,25Stn", "0,75Stn"), preis = c(50, 
45, 70, 90, 10, 60), bf = c(12L, 12L, 12L, 12L, 12L, 12L), primeattrID = c("ATTR_6", 
...
"index.php/messer.html", "index.php/schwerer-dolch.html")), row.names = c(NA, 
6L), class = "data.frame")
wp
```
